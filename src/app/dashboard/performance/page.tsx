  ...
  return (
    <div className={`min-h-screen transition-colors duration-200 ${darkMode
      ...
      <div className="ml-16 lg:ml-72 transition-all duration-300">
        ...
        <div className="p-6">
          <div className={`rounded-2xl p-8 transition-colors duration-200 ${darkMode
            ...
            <p className={`transition-colors duration-200 ${darkMode ? 'text-gray-300' : 'text-slate-600'
              }`}>
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className={`rounded-xl p-6 transition-colors duration-200 ${darkMode
                  ? 'bg-gray-700/50'
                  : 'bg-slate-100'
                }`}>
                <h3 className={`font-bold mb-2 transition-colors duration-200 ${darkMode ? 'text-white' : 'text-slate-900'
                  }`}>
