      ...
      {displayedData.length > 0 ? (
        <div className="overflow-x-auto">
          <div className="min-w-full">
            {/* Header */}
            <div className="mb-2 flex border-b border-white/8 pb-2">
              <div className="w-1/4 text-sm font-medium text-slate-400">Model</div>
              <div className="w-1/4 text-sm font-medium text-slate-400">Response Time</div>
              <div className="w-2/4 text-sm font-medium text-slate-400">Distribution</div>
            </div>
            ...
            {displayedData.map((item, index) => {
              ...
              return (
                <div 
                  key={index} 
                  className="flex items-center rounded px-2 py-3 transition-colors hover:bg-white/5 border-b border-white/6"
