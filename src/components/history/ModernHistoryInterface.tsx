...
import AIFiestaLogo from '../landing/AIFiestaLogo'
    ...
    <div className={`flex h-screen transition-colors duration-200 ${darkMode
            ...
            {showProfileDropdown && (
              <>
                <div
                  ...
                  aria-hidden="true"
                />
                <div className={`absolute bottom-full right-0 mb-2 w-72 rounded-2xl shadow-2xl transition-all duration-300 transform origin-bottom z-50 ${darkMode
                  ...
                  {/* User Profile Header */}
                  <div className={`px-5 py-4 rounded-t-2xl ${darkMode
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className={`font-bold text-lg truncate ${darkMode ? 'text-white' : 'text-gray-900'
                          }`}>
                        ...
                        <div className="mt-1">
                          <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${darkMode
                  ...
                  <div className="py-2">
                    ...
                    <Link href="/profile">
                      <div
                        className={`flex items-center space-x-4 w-full px-5 py-3 text-left transition-all duration-200 ${darkMode
                      ...
                      >
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-colors ${darkMode
                    ...
                    <button
                      ...
                      className={`flex items-center space-x-4 w-full px-5 py-3 text-left transition-all duration-200 group ${darkMode
                    ...
                    {/* Theme Toggle */}
                    <div
                      className={`flex items-center justify-between px-5 py-3 transition-all duration-200 ${darkMode
                    ...
                    >
                      ...
                      <div className={`relative w-12 h-6 rounded-full transition-colors ${darkMode ? 'bg-indigo-600' : 'bg-gray-300'
                        }`}>
                        <div className={`absolute top-1 w-4 h-4 rounded-full bg-white transition-transform duration-300 ${darkMode ? 'transform translate-x-7' : 'translate-x-1'
                          }`}></div>
                      </div>
                    </div>

                    <div className={`px-5 py-2 ${darkMode ? 'border-gray-700/50' : 'border-gray-200/50'
                      }`}>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div className="relative max-w-md flex-1">
                <Search className={`absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 transition-colors duration-200 ${darkMode ? 'text-gray-400' : 'text-slate-400'
                  }`} />
                <input
                  type="text"
                  ...
                  className={`w-full pl-10 pr-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition-all duration-300 text-sm placeholder:text-slate-500 backdrop-blur-sm ${darkMode
              ...
              <div className="flex items-center space-x-3 relative">
                ...
                <button
                  ...
                  className={`px-4 py-3 rounded-xl transition-all duration-300 flex items-center space-x-2 backdrop-blur-sm ${darkMode
                ...
                <div className="relative">
                  <button
                    ...
                    className={`flex items-center space-x-2 px-4 py-3 rounded-xl transition-all duration-200 ${darkMode
                  ...
                  {showSortFilterDropdown === 'sort' && (
                    <div id="sort-dropdown" className={`absolute right-0 mt-2 w-48 rounded-2xl border shadow-2xl z-[9999] overflow-hidden backdrop-blur-xl ${darkMode
                      ? 'bg-gray-800/90 border-gray-700/50'
                      : 'bg-white/90 border-slate-200/50'
                      }`}>
                      <div className="py-2">
                        <div className="px-4 py-2">
                          <h3 className={`text-sm font-semibold mb-2 ${darkMode ? 'text-gray-300' : 'text-slate-700'
                            }`}>
                            Sort By
                          </h3>
                          <div className="space-y-1">
                            <button
                              ...
                              className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors duration-200 flex items-center justify-between ${sortBy === 'newest'
                                ? darkMode
                            ...
                            <button
                              ...
                              className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors duration-200 flex items-center justify-between ${sortBy === 'oldest'
                                ? darkMode
                                  ? 'bg-blue-900/30 text-blue-300'
                                  : 'bg-blue-100 text-blue-700'
                                : darkMode
                            ...
                            <button
                              ...
                              className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors duration-200 flex items-center justify-between ${sortBy === 'mostResponses'
                                ? darkMode
                                  ? 'bg-blue-900/30 text-blue-300'
                                  : 'bg-blue-100 text-blue-700'
                                : darkMode
                ...
                <div className="relative">
                  ...
                  {showSortFilterDropdown === 'filter' && (
                    <div id="filter-dropdown" className={`absolute right-0 mt-2 w-48 rounded-2xl border shadow-2xl z-[9999] overflow-hidden backdrop-blur-xl ${darkMode
                      ? 'bg-gray-800/90 border-gray-700/50'
                      : 'bg-white/90 border-slate-200/50'
                      }`}>
                      <div className="py-2">
                        <div className={`px-4 py-2 border-t ${darkMode ? 'border-gray-700/50' : 'border-slate-200/50'
                          }`}>
                          <h3 className={`text-sm font-semibold mb-2 ${darkMode ? 'text-gray-300' : 'text-slate-700'
                            }`}>
                            Filter By Model
                          ...
                          <div className="space-y-1">
                            <button
                              ...
                              className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors duration-200 flex items-center justify-between ${filterByModel === 'all'
                                ? darkMode
                                  ? 'bg-blue-900/30 text-blue-300'
                                  : 'bg-blue-100 text-blue-700'
                                : darkMode
                            ...
                            {getUniqueModels().map(modelId => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors duration-200 flex items-center justify-between ${filterByModel === modelId
                                    ? darkMode
                                      ? 'bg-blue-900/30 text-blue-300'
                                      : 'bg-blue-100 text-blue-700'
                                    : darkMode
          ...
          <div className="h-full p-6">
            <div className="max-w-7xl mx-auto h-full flex flex-col">
              {isLoading ? (
                ...
                <div className="h-full flex flex-col items-center justify-center">
                  <div className={`w-24 h-24 rounded-3xl flex items-center justify-center mb-6 backdrop-blur-sm ${darkMode ? 'bg-gray-800/50' : 'bg-white/50'
                    }`}>
                    <AlertCircle className={`w-12 h-12 ${darkMode ? 'text-red-500' : 'text-red-500'
                      }`} />
                  </div>
                  <h2 className={`text-2xl font-bold mb-2 transition-colors duration-200 ${darkMode ? 'text-white' : 'text-slate-900'
                    }`}>
                  ...
                  <p className={`text-lg mb-6 text-center max-w-md transition-colors duration-200 ${darkMode ? 'text-gray-400' : 'text-slate-600'
                    }`}>
                    {error}
                  </p>
                  <button
                ...
                <div className="h-full flex flex-col items-center justify-center">
                  <div className={`w-24 h-24 rounded-3xl flex items-center justify-center mb-6 backdrop-blur-sm ${darkMode ? 'bg-gray-800/50' : 'bg-white/50'
                    ...
                    <Clock className={`w-12 h-12 ${darkMode ? 'text-gray-500' : 'text-slate-400'
                      }`} />
                  </div>
                  ...
                  <p className={`text-xl mb-8 text-center max-w-md transition-colors duration-200 ${darkMode ? 'text-gray-400' : 'text-slate-600'
                    }`}>
                ...
                <div className="flex-1 overflow-y-auto pb-6">
                  ...
                  <div className="flex justify-end mb-4">
                    <div className={`inline-flex rounded-xl p-1 ${darkMode ? 'bg-gray-800/50 backdrop-blur-sm' : 'bg-white/50 backdrop-blur-sm'
                      }`}>
                      <button
                  ...
                  {viewMode === 'grid' ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {filteredSessions.map((session: ChatSession) => (
                        <div
                          key={session.id}
                          className={`rounded-2xl border transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 backdrop-blur-sm overflow-hidden ${darkMode
                        ...
                        >
                          ...
                          >
                            <div className="flex items-start justify-between mb-3">
                              <div className="flex items-center space-x-2">
                                <MessageSquare className={`w-5 h-5 ${darkMode ? 'text-blue-400' : 'text-blue-500'
                                  }`} />
                              ...
                              <button
                                ...
                                className={`p-1.5 rounded-lg transition-colors duration-200 ${darkMode
                            ...
                            <div className={`mb-3 transition-colors duration-200 ${darkMode ? 'text-white' : 'text-slate-900'
                              }`}>
                            ...
                            <div className="flex-1 flex items-center justify-center my-3">
                              <div className={`flex flex-wrap gap-2 justify-center ${darkMode ? 'text-gray-300' : 'text-slate-600'
                                }`}>
                                {session.selectedModels.slice(0, 3).map((modelId: string) => {
                                  ...
                                  return (
                                    <span
                                      key={modelId}
                                      className={`text-xs px-2.5 py-1 rounded-full flex items-center space-x-1 ${darkMode
                                        ? 'bg-gray-700/50'
                                        : 'bg-slate-100'
                                        }`}
                                    >
                                ...
                                {session.selectedModels.length > 3 && (
                                  <span className={`text-xs px-2.5 py-1 rounded-full ${darkMode
                                    ? 'bg-gray-700/50'
                                    : 'bg-slate-100'
                                    }`}>
                                    +{session.selectedModels.length - 3}
                            ...
                            <div className={`flex items-center justify-between pt-3 border-t ${darkMode ? 'border-gray-700/30' : 'border-slate-200/30'
                              }`}>
                              <div className={`flex items-center space-x-1 text-sm font-medium ${darkMode ? 'text-blue-400' : 'text-blue-600'
                                }`}>
                                <MessageSquare className="w-4 h-4" />
                                <span>{session.responseCount} responses</span>
                              </div>
                              <div className={`flex items-center space-x-1 text-xs px-2 py-1 rounded-full ${darkMode ? 'bg-blue-900/30 text-blue-300' : 'bg-blue-100 text-blue-700'
                                }`}>
                    ...
                    <div className="space-y-6">
                      {filteredSessions.map((session: ChatSession) => (
                        <div
                          key={session.id}
                          className={`rounded-2xl border transition-all duration-300 backdrop-blur-sm ${darkMode
                        ...
                        >
                          ...
                          >
                            <div className="flex items-start justify-between mb-3">
                              <div className="flex items-center space-x-2">
                                <MessageSquare className={`w-5 h-5 ${darkMode ? 'text-gray-400' : 'text-slate-500'
                                  }`} />
                                <span className={`text-sm font-medium ${darkMode ? 'text-gray-300' : 'text-slate-600'
                                  }`}>
                                  {formatTimeAgo(session.timestamp)}
                              ...
                              <button
                                ...
                                className={`p-1 rounded-lg transition-colors duration-200 ${darkMode
                                  ? 'text-gray-400 hover:text-red-400 hover:bg-gray-700'
                                  : 'text-slate-400 hover:text-red-500 hover:bg-slate-100'
                                  }`}
                                title="Delete conversation"
                            ...
                            <h3 className={`font-semibold mb-3 line-clamp-2 transition-colors duration-200 ${darkMode ? 'text-white' : 'text-slate-900'
                              }`}>
                              {session.message}
                            </h3>
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className={`flex items-center space-x-1 text-xs ${darkMode ? 'text-gray-400' : 'text-slate-500'
                                }`}>
                                <MessageSquare className="w-4 h-4" />
      ...
      {showDeleteAllPopup && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className={`rounded-2xl border shadow-2xl max-w-md w-full backdrop-blur-xl ${darkMode
              ...
              {isDeletingAll ? (
                ...
                <>
                  ...
                  <div className="flex justify-end space-x-3">
                    <button
                      onClick={() => setShowDeleteAllPopup(false)}
                      className={`px-4 py-2 rounded-xl font-medium transition-colors duration-200 ${darkMode
      ...
      {selectedResponse && (
        ...
        >
          <div
            className={`relative w-full max-w-4xl max-h-[90vh] overflow-hidden rounded-2xl border shadow-2xl ${darkMode
            ...
            <div className="p-8 h-full flex flex-col">
              ...
              <div className="mb-6">
                <div className="flex items-center space-x-4 mb-4">
                  <div className={`w-16 h-16 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg ${selectedResponse?.isBestResponse
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-2 mt-2">
                      <span className={`text-sm font-medium px-3 py-1 rounded-full ${selectedResponse?.isBestResponse
                        ? darkMode
                      ...
                      {selectedResponse?.isBestResponse && (
                        <div className={`flex items-center space-x-1 ${darkMode ? 'text-amber-400' : 'text-amber-600'
                          }`}>
                      ...
                      {selectedResponse?.responseTime !== undefined && selectedResponse?.responseTime > 0 && (
                        <div className={`text-sm font-medium px-3 py-1 rounded-full ${darkMode
                ...
                {selectedResponse?.error ? (
                  <div className="h-full flex items-center justify-center p-8">
                    <div className="text-center max-w-md">
                      ...
                      <div className={`text-sm p-6 rounded-xl text-left max-h-40 overflow-y-auto ${darkMode ? 'bg-red-900/30 text-red-300' : 'bg-red-50 text-red-500'
                        }`}>
                        {selectedResponse?.error}
                      </div>
                    </div>
                  ...
                  <div className="h-full flex flex-col">
                    ...
                    <div className={`flex-1 rounded-xl p-6 mb-6 overflow-y-auto max-h-[70vh] ${darkMode ? 'bg-gray-800/50' : 'bg-gray-50'
                      }`}>
                      <div className={`prose max-w-none ${darkMode ? 'prose-invert' : ''
                        }`}>
                        <div className={`whitespace-pre-wrap text-lg ${darkMode ? 'text-slate-100' : 'text-slate-700'
                          }`}>
                          {selectedResponse?.content}
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                      ...
                      <button
                        ...
                        className={`flex items-center space-x-2 px-5 py-2.5 rounded-lg font-medium transition-all ${darkMode
                  ...
                  <div className="h-full flex items-center justify-center p-8">
                    <div className="text-center">
                      <div className={`w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 ${selectedResponse?.isBestResponse
                        ? 'bg-gradient-to-br from-amber-100 to-yellow-100'
                        : darkMode
                          ? 'bg-gray-700'
                          : 'bg-gradient-to-br from-slate-100 to-slate-200'
                        }`}>
                        <Sparkles className={`w-10 h-10 ${selectedResponse?.isBestResponse ? 'text-amber-500' : darkMode ? 'text-slate-400' : 'text-slate-400'
                          }`} />
                      </div>
                      <h3 className={`text-2xl font-bold mb-3 ${darkMode ? 'text-white' : 'text-gray-900'
                        }`}>
