...
export const CelestialSphere: React.FC<CelestialSphereProps> = ({
    ...
    `;
        ...
        const onMouseMove = (event: MouseEvent) => {
            ...
            // Pass raw mouse coordinates or normalized? Shader expects raw for resolution division, but code above did:
            // vec2 mouse_normalized = u_mouse / u_resolution; 
            // So passing pixels is correct.
            // But shader Y is usually flipped in WebGL vs Screen?
            // Code: material.uniforms.u_mouse.value.set(mouse.x, currentMount.clientHeight - mouse.y);
            // This flips Y, which is good.
        ...
        return () => {
            ...
            renderer.dispose();
            material.dispose();
            // geometry is simple plane, can dispose or leave
        };
